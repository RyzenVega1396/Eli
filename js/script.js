...
function createBox ( box, pos ) {
    ...
    // Followers 
    // Reemplaza la sección "Followers" con esto:
var baseHue = 0; // Rojo puro
var hueVariation = 0; // Sin variación
var saturation = 100; // Saturación máxima
var color = 'hsl(' + baseHue + ', ' + saturation + '%, ' + bright + '%)';
...
function drawGalaxy() {
    ...
    function animate() {
        ...
        for (var i = 0; i < stars.length; i++) {
            ...
            ctx.fillStyle = 'rgba(195, 182, 255, 0.9)';
            ctx.shadowColor = '#300abb';
